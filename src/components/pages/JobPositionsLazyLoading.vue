  ...
  <div class="container content-section">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="skills-section" ref="scrollContainer" @scroll="handleScroll">

          <div class="card2" v-for="(skill, index) in items" :key="index">
      ...
      if (this.currentPage <= this.totalPages && !this.loading) {
        ...
        setTimeout(() => {
          for (let i = 0; i < this.itemsPerPage; i++) {
            let index = i+((this.currentPage-1)*this.itemsPerPage);
            if (index < this.skills.length) {
                this.items.push(this.skills[index]);
            } else {
                break; 
            }
          }
